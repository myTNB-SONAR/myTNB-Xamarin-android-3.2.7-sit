...
namespace myTNB
{
    public partial class NonLoginBillRelatedFeedbackViewController : UIViewController
    {
        public NonLoginBillRelatedFeedbackViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        UILabel _lblAccountNoTitle;
        UILabel _lblAccountNoError;
        UIView _viewAccountNo;
        UIView _viewLineAccountNo;
        ...
        internal void InitializedSubviews()
        {
            ...
            _viewAccountNo = new UIView((new CGRect(18, 217, View.Frame.Width - 36, 51)));
            _viewAccountNo.BackgroundColor = UIColor.Clear;
            ...
            _viewAccountNo.AddSubview(_lblAccountNoTitle);
            ...
            _viewAccountNo.AddSubview(_lblAccountNoError);
            ...
            _viewAccountNo.AddSubview(_txtFieldAccountNo);

            _viewLineAccountNo = new UIView((new CGRect(0, 36, _viewAccountNo.Frame.Width, 1)));
            _viewLineAccountNo.BackgroundColor = myTNBColor.PlatinumGrey();
            _viewAccountNo.AddSubview(_viewLineAccountNo);

            //Feedback

            _viewFeedback = new UIView((new CGRect(18, 284, View.Frame.Width - 36, 51)));
            ...
            //Photo/s Title
            var lblPhotoTitle = new UILabel(new CGRect(18, 341, View.Frame.Width - 36, 14));
            ...
            var btnSubmitYCoord = DeviceHelper.IsIphone5() ? 20 : 128;
            _btnSubmit.Frame = new CGRect(18, View.Frame.Height - (DeviceHelper.IsIphoneX() ? 152 : btnSubmitYCoord), View.Frame.Width - 36, 48);
            ...
            ScrollView.AddSubview(_viewAccountNo);
        ...
        {
            bool isValidFullName = _textFieldHelper.ValidateTextField(_txtFieldFullName.Text, NAME_PATTERN);
        ...
        internal void SetEvents()
        {
            ...
            SetTextFieldEvents(_txtFieldEmail, _lblEmailTitle
                               ...
                               , null, EMAIL_PATTERN);
            SetTextFieldEvents(_txtFieldAccountNo, _lblAccountNoTitle
                               , _lblAccountNoError, _viewLineAccountNo
                               , null, ACCOUNT_NO_PATTERN);
                ...
                NetworkUtility.CheckConnectivity().ContinueWith(networkTask =>
                {
                    InvokeOnMainThread(() =>
                    {
                        if (NetworkUtility.isReachable)
                        {
                            ...
                            _mobileNumber = _txtFieldMobileNo.Text;
                            _email = _txtFieldEmail.Text;
                            _accountNumber = _txtFieldAccountNo.Text;
        ...
        internal void AddImageContainer()
        {
            if (capturedImageCount < MAX_IMAGE)
            {
                ...
                {
                    imageContainerScroll = new UIScrollView(new CGRect(18, 365, View.Frame.Width - 36, 94));
                ...
                dashedLineView.AddGestureRecognizer(new UITapGestureRecognizer(() =>
                {
                    ...
                    imgPickerDelegate.Type = Enums.FeedbackCategory.NonLoginBillRelated;
