...
namespace myTNB.AndroidApp.Src.Feedback_PreLogIn_Others.Adapter
{
    public class FeedbackPreLoginOthersImageRecyclerAdapter : BaseRecyclerAdapter<AttachedImage>
    {

        public event EventHandler<int> RemoveClickEvent;
        public event EventHandler<int> AddClickEvent;

        public FeedbackPreLoginOthersImageRecyclerAdapter(bool notify) : base(notify)
        {
        }

        public FeedbackPreLoginOthersImageRecyclerAdapter(List<AttachedImage> itemList) : base(itemList)
        {
        }

        public FeedbackPreLoginOthersImageRecyclerAdapter(List<AttachedImage> itemList, bool notify) : base(itemList, notify)
        {
        }
