...
namespace myTNB_Android.Src.MakePayment.Adapter
{
    class AddCardAdapter : BaseAdapter
    {
        List<CreditCard> cardList;
        Android.App.Activity activity;
        public event EventHandler<int> OnItemClick;

        public AddCardAdapter(Android.App.Activity activity, List<CreditCard> cards)
        {
