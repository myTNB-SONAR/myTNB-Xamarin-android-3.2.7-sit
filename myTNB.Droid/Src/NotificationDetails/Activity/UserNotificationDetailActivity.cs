...
using Refit;
using Constant = myTNB.Android.Src.Utils.LinkRedirection.LinkRedirection.Constants;
...
namespace myTNB.Android.Src.NotificationDetails.Activity
{
