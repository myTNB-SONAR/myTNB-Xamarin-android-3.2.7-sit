...
using myTNB.AndroidApp.Src.NotificationDetails.MVP;
...
using myTNB.AndroidApp.Src.ServiceDistruptionRating.Activity;
...
using Refit;
using Constant = myTNB.AndroidApp.Src.Utils.LinkRedirection.LinkRedirection.Constants;
using Screen = myTNB.AndroidApp.Src.Utils.LinkRedirection.LinkRedirection.ScreenEnum;
...
namespace myTNB.AndroidApp.Src.NotificationDetails.Activity
{
