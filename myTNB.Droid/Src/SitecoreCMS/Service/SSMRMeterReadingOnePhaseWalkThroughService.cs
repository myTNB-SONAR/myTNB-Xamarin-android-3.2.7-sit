...
{
    public class SSMRMeterReadingOnePhaseWalkThroughService
    {
        private string _os, _imgSize, _websiteURL, _language;
        internal SSMRMeterReadingOnePhaseWalkThroughService(string os, string imageSize, string websiteUrl = null, string language = "en")
        {
            _os = os;
            _imgSize = imageSize;
        ...
        internal List<SSMRMeterReadingModel> GetItems()
        {
            ...
            var req = sitecoreService.GetItemByPath(Constants.Sitecore.ItemPath.SSMRMeterReadingOnePhaseWalkthrough
        ...
        private async Task<IEnumerable<SSMRMeterReadingModel>> ParseToChildrenItems(ScItemsResponse itemsResponse)
        {
            ...
            {
                Debug.WriteLine("Exception in SSMRMeterReadingOnePhaseWalkThroughService/GetChildren: " + e.Message);
            }
            return list;
        }
        ...
        private async Task<SSMRMeterReadingTimeStamp> ParseToTimestamp(ScItemsResponse itemsResponse)
        {
            ...
            {
                Debug.WriteLine("Exception in SSMRMeterReadingOnePhaseWalkThroughService/GenerateTimestamp: " + e.Message);
            }
            return new SSMRMeterReadingTimeStamp();
        }
    }
