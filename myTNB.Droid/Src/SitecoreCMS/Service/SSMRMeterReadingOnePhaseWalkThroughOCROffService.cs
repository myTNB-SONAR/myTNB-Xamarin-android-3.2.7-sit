...
{
    public class SSMRMeterReadingOnePhaseWalkThroughOCROffService
    {
        private string _os, _imgSize, _websiteURL, _language;
        internal SSMRMeterReadingOnePhaseWalkThroughOCROffService(string os, string imageSize, string websiteUrl = null, string language = "en")
        {
            _os = os;
            _imgSize = imageSize;
        ...
        internal List<SSMRMeterReadingModel> GetItems()
        {
            ...
            var req = sitecoreService.GetItemByPath(Constants.Sitecore.ItemPath.SSMRMeterReadingOnePhaseWalkthroughOCROff
        ...
        private async Task<IEnumerable<SSMRMeterReadingModel>> ParseToChildrenItems(ScItemsResponse itemsResponse)
        {
            ...
            {
                Debug.WriteLine("Exception in SSMRMeterReadingOnePhaseWalkThroughOCROffService/GetChildren: " + e.Message);
            }
            return list;
        }
        ...
        private async Task<SSMRMeterReadingTimeStamp> ParseToTimestamp(ScItemsResponse itemsResponse)
        {
            ...
            {
                Debug.WriteLine("Exception in SSMRMeterReadingOnePhaseWalkThroughOCROffService/GenerateTimestamp: " + e.Message);
            }
            return new SSMRMeterReadingTimeStamp();
        }
    }
