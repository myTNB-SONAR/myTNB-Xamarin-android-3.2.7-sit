...
using myTNB_Android.Src.FeedbackAboutBillEnquiryStepTwo.MVP;
...
namespace myTNB_Android.Src.FeedbackAboutBillEnquiryStepTwo.Activity
{
   ...
   , Theme = "@style/Theme.FaultyStreetLamps")]
    ...
    public class FeedbackAboutBillEnquiryStepTwoActivity : BaseActivityCustom, FeedbackAboutBillEnquiryStepTwoContract.IView
    {

        FeedbackAboutBillEnquiryStepTwoContract.IUserActionsListener userActionsListener;
        FeedbackAboutBillEnquiryStepTwoPresenter mPresenter;
        ...
        [BindView(Resource.Id.txtTermsConditionsAboutBillEnquiry)]
        TextView txtTermsConditionsAboutBillEnquiry;
        ...
        protected override void OnCreate(Android.OS.Bundle savedInstanceState)
        {
            ...
            {
                //1 set presenter
                mPresenter = new FeedbackAboutBillEnquiryStepTwoPresenter(this);
                ...
                txtTermsConditionsAboutBillEnquiry.TextFormatted = GetFormattedText(Utility.GetLocalizedLabel("SubmitEnquiry", "enquiryTnc"));

                StripUnderlinesFromLinks(txtTermsConditionsAboutBillEnquiry);
                ...
                TextViewUtils.SetTextSize12(txtstep2of2, txtTermsConditionsAboutBillEnquiry);
        ...
        {
            return Resource.Layout.FeedbackAboutBillEnquiryStepTwoView;
        }

        public void SetPresenter(FeedbackAboutBillEnquiryStepTwoContract.IUserActionsListener userActionListener)
        {
        ...
        [OnClick(Resource.Id.txtTermsConditionsAboutBillEnquiry)]
        ...
        public void toggleTNC()
        {
            ...
            if (toggleTncData)
            {
                txtTermsConditionsAboutBillEnquiry.TextFormatted = GetFormattedText(Utility.GetLocalizedLabel("SubmitEnquiry", "enquiryTncRead"));
                StripUnderlinesFromLinks(txtTermsConditionsAboutBillEnquiry);
            }
            else
            {
