...
namespace myTNB_Android.Src.NewAppTutorial.Adapter
{
    public class NewAppTutorialPagerAdapter : PagerAdapter
    {
        ...
        public override Java.Lang.Object InstantiateItem(ViewGroup container, int position)
        {
            ...
            {
                int middleHeight = ((DashboardHomeActivity)this.mContext).GetViewBillButtonHeight() + (int)DPUtils.ConvertDPToPx(10f);
                int topHeight = ((DashboardHomeActivity)this.mContext).GetTopHeight();
