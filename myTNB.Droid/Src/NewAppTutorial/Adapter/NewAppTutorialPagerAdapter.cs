    ...
    public class NewAppTutorialPagerAdapter : PagerAdapter
    {
        ...
        public override Java.Lang.Object InstantiateItem(ViewGroup container, int position)
        {
            ...
            if (this.mFragment != null)
            {
                ...
                if (this.mFragment is HomeMenuFragment && ncAcc > 0)
                {
                    if (ncAcc > 3)
                    {
                        if (position == 0)
                    ...
                    else if (ncAcc == 3)
                    {
                        ...
                        //{
                        //    int topHeight;
                        //    if (model.ItemCount > 3 || model.ItemCount == 3)
                        //    {
                        //        topHeight = ((HomeMenuFragment)this.mFragment).GettopRootViewHeight() + (int)DPUtils.ConvertDPToPx(38f) - ((HomeMenuFragment)this.mFragment).GetloadMoreContainerHeight();
                    ...
                    else if (ncAcc == 2)
                    {
                        ...
                        //    if (model.ItemCount > 3 || model.ItemCount == 3)
                        //    {
                        //        topHeight = ((HomeMenuFragment)this.mFragment).GettopRootViewHeight() + (int)DPUtils.ConvertDPToPx(12f);
