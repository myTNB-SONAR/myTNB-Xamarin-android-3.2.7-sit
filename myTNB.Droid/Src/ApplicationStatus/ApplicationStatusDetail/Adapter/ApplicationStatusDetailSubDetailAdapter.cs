...
namespace myTNB.AndroidApp.Src.ApplicationStatus.ApplicationStatusDetail.Adapter
{
        ...
        public class ApplicationDetailSubDetailViewHolder : RecyclerView.ViewHolder
        {
            ...
            public void PopulateData(TitleValueModel item)
            {
                ...
                try
                {
                    ...
                    TextViewUtils.SetTextSize10(TxtApplicationStatusHeader);
                    TextViewUtils.SetTextSize14(TxtApplicationStatusDetail);
                }
                catch (Exception e)
                {
