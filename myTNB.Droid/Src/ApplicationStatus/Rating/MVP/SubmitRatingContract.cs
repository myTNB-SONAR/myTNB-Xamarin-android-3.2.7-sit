...
using myTNB_Android.Src.ApplicationStatusRating.Request;
using myTNB_Android.Src.ApplicationStatusRating.Response;
using System;
using System.Collections.Generic;
using static myTNB_Android.Src.ApplicationStatusRating.Request.SubmitRateUsRequest;

namespace myTNB_Android.Src.ApplicationStatusRating.MVP
{
