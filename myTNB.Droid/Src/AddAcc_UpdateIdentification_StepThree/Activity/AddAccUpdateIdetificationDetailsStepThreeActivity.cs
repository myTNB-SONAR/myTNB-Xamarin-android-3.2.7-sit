...
using Java.Text;
using Java.Util;
using myTNB_Android.Src.AddAcc_UpdateIdentification_StepFour.Activity;
using myTNB_Android.Src.AddAcc_UpdateIdentification_StepThree.MVP;
...
namespace myTNB_Android.Src.AddAcc_UpdateIdentification_StepThree.Activity
{
    [Activity(ScreenOrientation = ScreenOrientation.Portrait
        , WindowSoftInputMode = SoftInput.AdjustPan
        , Theme = "@style/Theme.OwnerTenantBaseTheme")]
    public class AddAccUpdateIdetificationDetailsStepThreeActivity : BaseToolbarAppCompatActivity, AddAccUpdateIdetificationDetailsStepThreeContract.IView
    {
        AddAccUpdateIdetificationDetailsStepThreeContract.IUserActionsListener userActionsListener;

        AddAccUpdateIdetificationDetailsStepThreePresenter mPresenter;

        [BindView(Resource.Id.rootView)]
        CoordinatorLayout rootView;

        [BindView(Resource.Id.txtstep)]
        TextView txtstep;
        ...
        [BindView(Resource.Id.TextViewtitle_backIC)]
        TextView TextViewtitle_backIC;
        ...
        protected override void OnCreate(Android.OS.Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                //1 set presenter
                mPresenter = new AddAccUpdateIdetificationDetailsStepThreePresenter(this);
                ...
                txtstep.Text = Utility.GetLocalizedLabel("SubmitEnquiry", "pageStep3");
                CopyOfOwnerLabel.Text = Utility.GetLocalizedLabel("SubmitEnquiry", "copyOfOwnerLabel");
                uploadSupportingDoc.Text = Utility.GetLocalizedLabel("SubmitEnquiry", "uploadDocTitle");
                TextViewtitle_frontIC.Text = Utility.GetLocalizedLabel("SubmitEnquiry", "frontIc");
                ...
                //    TextViewtitle_backIC.Visibility = ViewStates.Gone;
        ...
        void OnSubmit(object sender, EventArgs eventArgs)
        {
            try
            {
                if (!this.GetIsClicked())
                {
                    ...
                    var Intent = new Intent(this, typeof(AddAccUpdateIdentificationStepFourActivity));
        ...
        public void SetPresenter(AddAccUpdateIdetificationDetailsStepThreeContract.IUserActionsListener userActionListener)
        {
        ...
        {   //TODO change
            return Resource.Layout.AddAccountUpdateIdentificationStepThreeView;
        }
        ...
        //    }
        //    else
        //    {   /// if sql lite is return null , user local image
        //        MyTNBAppToolTipBuilder infoLabelWhoIsRegistered = MyTNBAppToolTipBuilder.Create(this, MyTNBAppToolTipBuilder.ToolTipType.IMAGE_HEADER)
        //        .SetHeaderImage(Resource.Drawable.ProofOfConsent)
        //        .SetTitle(Utility.GetLocalizedLabel("SubmitEnquiry", "consentTitle"))
        //        .SetMessage(Utility.GetLocalizedLabel("SubmitEnquiry", "poc"))
        //        .SetCTALabel(Utility.GetLocalizedCommonLabel("gotIt"))
        //        .SetCTAaction(() => { this.SetIsClicked(false); })
        ...
        public void ShowinfoLabelPermise()
        {
            ...
            {  // incase base 64 is corrupt or null
                ...
                MyTNBAppToolTipBuilder infoLabelWhoIsRegistered = MyTNBAppToolTipBuilder.Create(this, MyTNBAppToolTipBuilder.ToolTipType.IMAGE_HEADER)
                .SetHeaderImage(Resource.Drawable.CukaiPintuSample)
                .SetTitle(Utility.GetLocalizedLabel("SubmitEnquiry", "permisesTitle"))
                .SetMessage(Utility.GetLocalizedLabel("SubmitEnquiry", "permisesContent"))
                .SetCTALabel(Utility.GetLocalizedCommonLabel("gotIt"))
                .SetCTAaction(() => { this.SetIsClicked(false); })
