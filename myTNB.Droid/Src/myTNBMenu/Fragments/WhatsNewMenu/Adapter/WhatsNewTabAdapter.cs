...
{
    public class WhatsNewTabAdapter : FragmentStatePagerAdapter
    {
        private FragmentManager mManager;
        private List<WhatsNewItemFragment> mFragmentList = new List<WhatsNewItemFragment>();
        private List<string> mFragmentTitleList = new List<string>();
        private Context context;

        public WhatsNewTabAdapter(FragmentManager fm, Context context) : base(fm)
        {
            this.context = context;
            mFragmentList = new List<WhatsNewItemFragment>();
        ...
        public void AddFragment(WhatsNewItemFragment fragment, string title)
        {
