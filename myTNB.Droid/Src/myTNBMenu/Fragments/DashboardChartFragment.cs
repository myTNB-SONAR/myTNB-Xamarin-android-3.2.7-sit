...
using myTNB.AndroidApp.Src.myTNBMenu.Adapter;
using myTNB.AndroidApp.Src.myTNBMenu.ChartRenderer;
using myTNB.AndroidApp.Src.myTNBMenu.Charts.Formatter;
using myTNB.AndroidApp.Src.myTNBMenu.Charts.SelectedMarkerView;
...
using static myTNB.AndroidApp.Src.myTNBMenu.Listener.NMRESMDashboardScrollView;
...
namespace myTNB.AndroidApp.Src.myTNBMenu.Fragments
{
