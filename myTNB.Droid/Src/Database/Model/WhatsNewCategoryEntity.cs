    ...
    public class WhatsNewCategoryEntity
    {
        ...
        public void CreateTable()
        {
            ...
            try
            {
                ...
                List<SQLiteConnection.ColumnInfo> info = db.GetTableInfo("WhatsNewCategoryEntity");
        ...
        public List<WhatsNewCategoryEntity> GetAllItems()
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                itemList = db.Query<WhatsNewCategoryEntity>("select * from WhatsNewCategoryEntity");
                if (itemList == null)
                {
        ...
        public void RemoveItem(string categoryId)
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                db.Execute("Delete from WhatsNewCategoryEntity WHERE CategoryID = ?", categoryId);
            }
            catch (Exception e)
            {
        ...
        internal static int Count()
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                var existingRecord = db.Query<WhatsNewCategoryEntity>("SELECT * FROM WhatsNewCategoryEntity");
