...
{
    [Table("WhatsNewCategoryEntityV2")]
    public class WhatsNewCategoryEntity
    {
        ...
        public void CreateTable()
        {
            ...
            try
            {
                ...
                List<SQLiteConnection.ColumnInfo> info = db.GetTableInfo("WhatsNewCategoryEntityV2");
        ...
        public List<WhatsNewCategoryEntity> GetAllItems()
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                itemList = db.Query<WhatsNewCategoryEntity>("select * from WhatsNewCategoryEntityV2");
                if (itemList == null)
                {
        ...
        public void RemoveItem(string categoryId)
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                db.Execute("Delete from WhatsNewCategoryEntityV2 WHERE CategoryID = ?", categoryId);
            }
            catch (Exception e)
            {
        ...
        internal static int Count()
        {
            ...
            {
                var db = DBHelper.GetSQLiteConnection();
                var existingRecord = db.Query<WhatsNewCategoryEntity>("SELECT * FROM WhatsNewCategoryEntityV2");
