...
{
    public class ProfileDetailMainMenuItemComponent : LinearLayout
    {
        private TextView itemHeaderTitle;
        private LinearLayout profileItemContent;
        public ProfileDetailMainMenuItemComponent(Context context) : base(context)
        {
            InitializeViews(context);
        }

        public ProfileDetailMainMenuItemComponent(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            InitializeViews(context);
        }

        public ProfileDetailMainMenuItemComponent(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            InitializeViews(context);
        }

        public ProfileDetailMainMenuItemComponent(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) : base(context, attrs, defStyleAttr, defStyleRes)
        {
            InitializeViews(context);
        }
