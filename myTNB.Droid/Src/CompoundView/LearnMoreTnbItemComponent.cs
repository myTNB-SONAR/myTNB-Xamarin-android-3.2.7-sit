...
{
    public class LearnMoreTnbItemComponent : LinearLayout
    {
        private LinearLayout profileItemContent;
        public LearnMoreTnbItemComponent(Context context) : base(context)
        {
            InitializeViews(context);
        }

        public LearnMoreTnbItemComponent(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            InitializeViews(context);
        }

        public LearnMoreTnbItemComponent(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            InitializeViews(context);
        }

        public LearnMoreTnbItemComponent(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) : base(context, attrs, defStyleAttr, defStyleRes)
        {
            InitializeViews(context);
        }
        ...
        {
            Inflate(context, Resource.Layout.LearnMoreTnbItemLayout, this);
