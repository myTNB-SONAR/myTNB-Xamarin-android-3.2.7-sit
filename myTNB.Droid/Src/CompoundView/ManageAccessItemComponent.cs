...
{
    public class ManageAccessItemComponent : LinearLayout
    {
        private LinearLayout profileItemContent;
        public ManageAccessItemComponent(Context context) : base(context)
        {
            InitializeViews(context);
        }

        public ManageAccessItemComponent(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            InitializeViews(context);
        }

        public ManageAccessItemComponent(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            InitializeViews(context);
        }

        public ManageAccessItemComponent(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) : base(context, attrs, defStyleAttr, defStyleRes)
        {
            InitializeViews(context);
        }
        ...
        {
            Inflate(context, Resource.Layout.ManageUserItemLayout, this);
