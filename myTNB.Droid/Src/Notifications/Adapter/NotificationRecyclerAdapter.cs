...
using Java.Text;
using Java.Util;
using myTNB.AndroidApp.Src.Notifications.MVP;
...
namespace myTNB.AndroidApp.Src.Notifications.Adapter
{
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            try
            {
                    ...
                    || notificationData.BCRMNotificationTypeId.Equals(Constants.BCRM_NOTIFICATION_MYHOME_APP_UPDATE_GTM2_FOLLOW_UP_NOT_UPDATE))
                {
                    ...
                    || notificationData.BCRMNotificationTypeId.Equals(Constants.BCRM_NOTIFICATION_MYHOME_COA_RESUME_APPLICATION))
                {
                ...
                else if (notificationData.BCRMNotificationTypeId.Equals(Constants.BCRM_NOTIFICATION_MYHOME_COT_CURRENT_OWNER_SUBMITTED))
                {
                ...
                else if (notificationData.BCRMNotificationTypeId.Equals(Constants.BCRM_NOTIFICATION_MYHOME_COT_REQUEST))
                {
