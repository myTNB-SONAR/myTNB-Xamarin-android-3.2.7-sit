...
using myTNB.AndroidApp.Src.SelectFeedbackType.Adapter;
using myTNB.AndroidApp.Src.SelectFeedbackType.MVP;
...
namespace myTNB.AndroidApp.Src.SelectFeedbackType.Activity
{
