...
using static myTNB.AndroidApp.Src.AppLaunch.Models.MasterDataResponse;

namespace myTNB.AndroidApp.Src.SSMR.SSMRMeterReadingTooltip.Adapter
{
    public class SSMRMeterReadingPagerAdapter : PagerAdapter
    {
        ...
        public override Java.Lang.Object InstantiateItem(ViewGroup container, int position)
        {
            ...
            TextViewUtils.SetTextSize14(titleView, descriptionView);
