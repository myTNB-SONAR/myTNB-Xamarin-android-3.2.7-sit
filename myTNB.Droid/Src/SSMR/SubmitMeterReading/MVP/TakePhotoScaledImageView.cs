...
namespace myTNB.Android.Src.SSMR.SubmitMeterReading.MVP
{
    public class ScaleImageViewGestureDetector : GestureDetector.SimpleOnGestureListener
        {
            private readonly ScaledImageView m_ScaleImageView;
            public ScaleImageViewGestureDetector(ScaledImageView imageView)
            {
        ...
        public class ScaledImageView : ImageView, View.IOnTouchListener
        {
            ...
            public ScaledImageView(Context context, IAttributeSet attrs, int defStyle) :
