        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            switch (imageUrl)
            {
                ...
                case "walkthrough_img_install_9":
                    ...
                    imgParam.Height = imgHeight;
                    break;
                case "walkthrough_img_install_10":
                    imageSource.SetImageResource(Resource.Drawable.walkthrough_img_install_10);
                    bgLayout.SetBackgroundResource(bgResource);
                    ...
                    imgParam.Height = imgHeight;
                    break;
                case "walkthrough_img_install_11":
                    imageSource.SetImageResource(Resource.Drawable.walkthrough_img_install_11);
                    bgLayout.SetBackgroundResource(bgResource);
                    ...
                    imgParam.Height = imgHeight;
                    break;
                case "walkthrough_img_install_12":
                    imageSource.SetImageResource(Resource.Drawable.walkthrough_img_install_12);
                    bgLayout.SetBackgroundResource(bgResource);
