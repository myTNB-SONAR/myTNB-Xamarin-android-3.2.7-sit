...
namespace myTNB.AndroidApp.Src.Feedback_Login_Others.Adapter
{
    public class FeedbackLoginOthersImageRecyclerAdapter : BaseRecyclerAdapter<AttachedImage>
    {

        public event EventHandler<int> RemoveClickEvent;
        public event EventHandler<int> AddClickEvent;

        public FeedbackLoginOthersImageRecyclerAdapter(bool notify) : base(notify)
        {
        }

        public FeedbackLoginOthersImageRecyclerAdapter(List<AttachedImage> itemList) : base(itemList)
        {
        }

        public FeedbackLoginOthersImageRecyclerAdapter(List<AttachedImage> itemList, bool notify) : base(itemList, notify)
        {
        }
