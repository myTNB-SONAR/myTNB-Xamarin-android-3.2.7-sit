...
using myTNB.Android.Src.Feedback_Login_Others.Adapter;
using myTNB.Android.Src.Feedback_Login_Others.MVP;
...
namespace myTNB.Android.Src.Feedback_Login_Others.Activity
{
