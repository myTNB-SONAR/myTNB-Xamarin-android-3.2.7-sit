...
using myTNB.AndroidApp.Src.Feedback_Login_Others.Adapter;
using myTNB.AndroidApp.Src.Feedback_Login_Others.MVP;
...
namespace myTNB.AndroidApp.Src.Feedback_Login_Others.Activity
{
