...
namespace myTNB_Android.Src.UpdatePersonalDetailStepTwo.Adapter
{
    ...
    public class permiseAdapter : BaseRecyclerAdapter<AttachedImage>
    {
        ...
        public permiseAdapter(bool notify) : base(notify)
        {

        }

        public permiseAdapter(List<AttachedImage> itemList) : base(itemList)
        {
        }

        public permiseAdapter(List<AttachedImage> itemList, bool notify) : base(itemList, notify)
        {
        }
