...
namespace myTNB_Android.Src.UpdatePersonalDetailStepTwo.Adapter
{
    ...
    public class supportingDocAdapter : BaseRecyclerAdapter<AttachedImage>
    {
        ...
        public supportingDocAdapter(bool notify) : base(notify)
        {

        }

        public supportingDocAdapter(List<AttachedImage> itemList) : base(itemList)
        {
        }

        public supportingDocAdapter(List<AttachedImage> itemList, bool notify) : base(itemList, notify)
        {
        }
