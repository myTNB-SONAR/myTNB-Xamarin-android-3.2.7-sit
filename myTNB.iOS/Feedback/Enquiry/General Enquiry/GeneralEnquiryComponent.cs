...
{
    public class GeneralEnquiryComponent
    {
        private readonly GeneralEnquiryViewController _controller;
        ...
        private GeneralEnquiryCommonWidgets _feedbackCommonWidgets;

        public GeneralEnquiryComponent(GeneralEnquiryViewController viewController)
        {
        ...
        {
            _feedbackCommonWidgets = new GeneralEnquiryCommonWidgets(_controller.View) { ViewController = _controller };
