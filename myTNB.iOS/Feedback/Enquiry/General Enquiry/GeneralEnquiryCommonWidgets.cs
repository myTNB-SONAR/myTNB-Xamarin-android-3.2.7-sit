...
{
        public class GeneralEnquiryCommonWidgets
        {
            ...
            public GeneralEnquiryCommonWidgets(UIView view)
            {
                View = view;
            }
            ...
            public GeneralEnquiryViewController ViewController { set; private get; }
        }
