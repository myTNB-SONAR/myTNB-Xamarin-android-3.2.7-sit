...
namespace myTNB.SSMR.ReadingHistory
{
    internal static class SSMRReadingHistoryView
    {
        ...
        internal static void SetStartButton(this SSMRReadingHistoryViewController c)
        {
            ...
            c._ctaView = new CustomUIView(new CGRect(0, c.ViewHeight - height + c._navBarHeight + DeviceHelper.TopSafeAreaInset + DeviceHelper.BottomSafeAreaInset,
                c.ViewWidth, height))
            {
            ...
            c._readingHistoryTableView.Frame = new CGRect(c._readingHistoryTableView.Frame.Location
                    , new CGSize(c.ViewWidth, (c.ViewHeight + DeviceHelper.BottomSafeAreaInset - height)));
        }
        ...
        internal static void SetApplyItemsHidden(this SSMRReadingHistoryViewController c, bool hidden)
        {
            ...
            if (c._ctaView != null)
            {
                ...
                c._ctaView = null;
                c._readingHistoryTableView.Frame = new CGRect(c._readingHistoryTableView.Frame.Location
                    , new CGSize(c.ViewWidth, c.ViewHeight + DeviceHelper.BottomSafeAreaInset));
            }
