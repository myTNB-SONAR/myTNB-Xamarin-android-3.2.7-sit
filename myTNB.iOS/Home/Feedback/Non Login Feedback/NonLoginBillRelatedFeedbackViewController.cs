    ...
    public partial class NonLoginBillRelatedFeedbackViewController : UIViewController
    {
        ...
        internal void InitializedSubviews()
        {
            ...
            _lblAccountNoError = new UILabel
            {
                ...
                AttributedText = new NSAttributedString(
                                        "ErrInvalidAcctMultiLimit".Translate(),
                                           font: myTNBFont.MuseoSans11_300(),
                                        foregroundColor: myTNBColor.Tomato(),
                                        strokeWidth: 0
                                       ),
                                         ...
                                         , UILabel lblHint, string pattern)
        {
            ...
            textField.ShouldEndEditing = (sender) =>
            {
                ...
                if (textField == _txtFieldAccountNo)
                {
            ...
            textField.ShouldChangeCharacters += (txtField, range, replacementString) =>
            {
                ...
                else if (txtField == _txtFieldAccountNo)
                {
                    return count <= TNBGlobal.AccountNumberHighCharLimit;
                }
        ...
        internal void SubmitButtonEnable()
        {
            ...
            bool isValidAccountNo = _textFieldHelper.ValidateTextField(_txtFieldAccountNo.Text, ACCOUNT_NO_PATTERN) && _textFieldHelper.ValidateAccountNumberLength(_txtFieldAccountNo.Text);
                ...
                NetworkUtility.CheckConnectivity().ContinueWith(networkTask =>
                {
                    InvokeOnMainThread(() =>
                    {
                        if (NetworkUtility.isReachable)
                        {
                            ...
                            _mobileNumber = _txtFieldMobileNo.Text?.Trim()?.Replace(" ", string.Empty);
