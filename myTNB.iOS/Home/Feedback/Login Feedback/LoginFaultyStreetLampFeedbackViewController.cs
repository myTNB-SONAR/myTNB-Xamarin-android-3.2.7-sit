...
namespace myTNB
{
    public partial class LoginFaultyStreetLampFeedbackViewController : UIViewController
    {
        UIView _viewState;
        ...
        internal void InitializedSubviews()
        {
            ...
            //State 
            _viewState = new UIView((new CGRect(18, 135 + imgViewFaultyLampHeight, View.Frame.Width - 36, 51)));
            ...
            _viewLocation = new UIView((new CGRect(18, 202 + imgViewFaultyLampHeight, View.Frame.Width - 36, 51)));
            ...
            _viewPole = new UIView((new CGRect(18, 269 + imgViewFaultyLampHeight, View.Frame.Width - 36, 51)));
        ...
        public void CreateTextFieldRightView(UITextField textField, String imageName)
        {
            ...
            UITapGestureRecognizer tapLocation = new UITapGestureRecognizer(() =>
            {
                ...
                _locManager.LocMgr.AuthorizationChanged += (sender, e) =>
                {
                    ...
                    {
                        var alertTitle = "Location Access is not allowed";
                        var alertMessage = "Turn On Location Services to allow \"myTNB\" to determine your location";
                        var okCancelAlertController = UIAlertController.Create(alertTitle, alertMessage, UIAlertControllerStyle.Alert);
                        okCancelAlertController.AddAction(UIAlertAction.Create("Cancel", UIAlertActionStyle.Cancel, alert => Console.WriteLine("Cancel was clicked")));
                        okCancelAlertController.AddAction(UIAlertAction.Create("Go to Settings", UIAlertActionStyle.Default, alert => NavigateToSettings()));
