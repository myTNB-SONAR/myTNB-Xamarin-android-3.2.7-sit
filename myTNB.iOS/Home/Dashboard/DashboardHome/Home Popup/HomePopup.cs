...
namespace myTNB.Home.Dashboard.DashboardHome
{
    public static class HomePopup
    {
        ...
        private static void ConstructNormalPopUp(CustomUIViewController c)
        {
            ...
            UITextView textContent = GetBodyContent(WhatsNewItem.PopUp_Text_Content, ScaleUtility.GetYLocationFromFrame(imageView.Frame, 16));
        ...
        #region Text Content
        private static UITextView GetBodyContent(string message, nfloat yLoc)
        {
